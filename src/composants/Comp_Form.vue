...
<template>
  <div class="flex flex-col items-center">  
    ...
    <div class="flex flex-col gap-4">
      ...
      <select name="soins" class="rounded-lg bg-clear-primary-green font-quicksand text-desktop w-80 h-10" v-model="soin" id="soin" >
        <option disabled class="text-center">Sélectionner un soin</option>
        <option value="CONSULTATION DE PÉDICURIE" class="text-center">CONSULTATION DE PÉDICURIE</option>
        ...
        <option value="SEMELLES ORTHOPÉDIQUES" class="text-center">SEMELLES ORTHOPÉDIQUES</option>
      </select>
      ...
      <select name="pointure" class="rounded-lg bg-clear-primary-green font-quicksand text-desktop w-80 h-10" v-model="pointure" id="pointure" >
        <option disabled class="text-center">Sélectionner une pointure ( si demande de semelles )</option>
